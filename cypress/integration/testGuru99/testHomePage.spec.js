...
describe('Home page testing', () => {
    ...
    it('Correct Home Page main elements check', () => {
        ...
        */
        ...
        //Tests for main title and logo behaviour
        ...
        cy.get(".logo img[src='/logo.png']").should('be.visible');
        cy.log('');

        cy.log('Test-APOS-? Guru99 Bank subtitle check:');
    ...
    it('Navigation bar check', () => {
        ...
        cy.get('.container-fluid').contains("a", 'Selenium').should('be.visible').and('have.attr','href', '#');
        cy.get('.container-fluid').contains('a', 'Insurance Project').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/insurance/v1/index.php');
        cy.get('.container-fluid').contains('a', 'Agile Project').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/Agile_Project/Agi_V1/');
        cy.get('.container-fluid').contains('a', 'Bank Project').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/V1/index.php');
        cy.get('.container-fluid').contains('a', 'Security Project').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/Security/SEC_V1/index.php');
        cy.get('.container-fluid').contains('a', 'Telecom Project').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/telecom/index.html');
        cy.get('.container-fluid').contains('a', 'Payment Gateway Project').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/payment-gateway/index.php');
        cy.get('.container-fluid').contains('a', 'New Tours').should('be.visible').and('have.attr','href', 'http://demo.guru99.com/test/newtours/');
        cy.get('.container-fluid').contains('a', 'SEO').should('be.visible').and('have.attr','href', '#');
        cy.log('');
    });
    ...
    it('Navigation bar dropdown buttons check', () => {
        ...
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Flash Movie Demo','href=["../../test/flash-testing.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Radio & Checkbox Demo','href=["../../test/radio.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Table Demo','href=["../../test/table.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Accessing Link','href=["../../test/link.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Ajax Demo','href=["../../test/ajax.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Inside & Outside Block Level Tag','href=["../../test/block.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Delete Customer Form','href=["../../test/delete_customer.php"]').should('be.visible').click();
        cy.go('back');
        ...
        /*
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Yahoo','href=["../../test/yahoo.html"]').should('be.visible').click();
        cy.go('back');
        */
        ...
        /*
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Tooltip','href=["../../test/tooltip.html"]').should('be.visible').click();
        cy.go('back');
        */
        ...
        /*
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','File Upload','href=["../../test/upload/"]').should('be.visible').click();
        cy.go('back');
        */
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Login','href=["../../test/login.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Social Icon','href=["../..test/social-icon.html"]').should('be.visible').click();
        cy.go('back');
        ...
        /*
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Selenium Auto IT','href=["../../test/autoit.html"]').should('be.visible').click();
        cy.go('back');
        */
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Selenium IDE Test','href=["../../test/facebook.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Guru99 Demo Page','href=["../../test/guru99home/"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Scrollbar Demo','href=["../../test/guru99home/scrolling.html"]').should('be.visible').click();
        cy.go('back');
        ...
        /*
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','File Upload using Sikuli Demo','href=["../../test/image_upload/"]').should('be.visible').click();
        cy.go('back');
        */
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Cookie Handling Demo','href=["../../test/cookie/selenium_aut.php"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Drag and Drop Action','href=["../../test/drag_drop.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'Selenium').click();
        cy.get('ul.dropdown-menu').children().contains('a','Selenium DatePicker Demo','href=["../../test/"]').should('be.visible').click();
        cy.go('back');
        ...
        cy.get('ul.dropdown-menu').children().contains('a','Page-1','href=["http://demo.guru99.com/seo/page-1.html"]').should('be.visible').then ( a => {
            cy.visit(a.attr('href').replace('http', 'https'));
        });
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'SEO').click();
        cy.get('ul.dropdown-menu').children().contains('a','Page-2','href=["http://demo.guru99.com/seo/page-2.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'SEO').click();
        cy.get('ul.dropdown-menu').children().contains('a','Page-3','href=["http://demo.guru99.com/seo/page-3.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'SEO').click();
        cy.get('ul.dropdown-menu').children().contains('a','Page-4','href=["http://demo.guru99.com/seo/page-4.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'SEO').click();
        cy.get('ul.dropdown-menu').children().contains('a','Page-5','href=["http://demo.guru99.com/seo/page-5.html"]').should('be.visible').click();
        cy.go('back');
        cy.get('.container-fluid').contains("a", 'SEO').click();
        cy.get('ul.dropdown-menu').children().contains('a','Page-6','href=["http://demo.guru99.com/seo/page-6.html"]').should('be.visible').click();
        cy.go('back');
        */
        cy.log('');
    });
