...
describe('Telecom Project page testing', () => {
    ...
    it('Correct Telecom Project page redirect from Home page', () => {
        ...
        */
        ...
        cy.get('.container-fluid').contains('a', 'Telecom Project').should('be.visible').then ( a => {
    ...
    it('Correct Telecom Project page look', () => {
        ...
        cy.get('#header').children().should('have.class','left').children().contains('a[href="#menu"]','Menu').should('be.visible').click();
        ...
        //main links check
        cy.get('#one').contains('a[href="addcustomer.php"]','Add Customer').should('be.visible').click();
        cy.url().should('eq','https://demo.guru99.com/telecom/addcustomer.php');
        cy.go('back');
        cy.get('#one').contains('a[href="assigntariffplantocustomer.php"]','Add Tariff Plan to Customer').should('be.visible').click()
        cy.url().should('eq','https://demo.guru99.com/telecom/assigntariffplantocustomer.php');
        cy.go('back');;
        cy.get('#one').contains('a[href="addtariffplans.php"]','Add Tariff Plan').should('be.visible').click();
        cy.url().should('eq','https://demo.guru99.com/telecom/addtariffplans.php');
        cy.go('back');
        cy.get('#one').contains('a[href="billing.php"]','Pay Billing').should('be.visible').click();
    ...
    it('Correct Add Tariff Plan page look', () => {
        ...
        cy.get('input[id="rental1"]').should('have.attr','placeholder','Monthly Rental').and('have.attr','maxlength','5').and('be.visible');
        cy.get('input[id="local_minutes"]').should('have.attr','placeholder','Free Local Minutes').and('have.attr','maxlength','5').and('be.visible');
        cy.get('input[id="inter_minutes"]').should('have.attr','placeholder','Free International Minutes').and('have.attr','maxlength','5').and('be.visible');
        cy.get('input[id="sms_pack"]').should('have.attr','placeholder','Free SMS Pack').and('have.attr','maxlength','5').and('be.visible');
        cy.get('input[id="minutes_charges"]').should('have.attr','placeholder','Local Per Minutes Charges').and('have.attr','maxlength','3').and('be.visible');
        cy.get('input[id="inter_charges"]').should('have.attr','placeholder','Inter. Per Minutes Charges').and('have.attr','maxlength','3').and('be.visible');
        cy.get('input[id="sms_charges"]').should('have.attr','placeholder','SMS Per Charges').and('have.attr','maxlength','3').and('be.visible');
        cy.log('');
    });
